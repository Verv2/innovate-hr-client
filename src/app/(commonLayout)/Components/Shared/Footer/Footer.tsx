  ...
  return (
    <footer className="border-b bg-white pt-20 dark:bg-transparent">
      <div className="mb-8 border-b md:mb-12">
        <div className="mx-auto max-w-5xl flex flex-wrap items-end justify-between gap-6 px-6 pb-6">
          <Link href="/" aria-label="go home" className="block size-fit">
            <Image
              src="https://i.pinimg.com/736x/c0/37/f8/c037f842a55fd6af2343ef7ae1681cc2.jpg"
              width={32}
              height={32}
              className="max-h-12"
              alt="logo"
